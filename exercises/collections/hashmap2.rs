...
fn fruit_basket(basket: &mut HashMap<Fruit, u32>) {
    ...
    for fruit in fruit_kinds {
        ...
        // match fruit {
        //     Fruit::Apple => println!("No more apples allowed!"),
        //     Fruit::Lichi => println!("No more lichi allowed!"), 
        //     Fruit::Mango => println!("No more mangos allowed!"),
        //     _ => {
        //         println!("Added 2 {:?} to the basket", fruit);
